          ...
          <div class="col-sm-12">
              ...
              <div class="card">
                  <div class="card-header">
                        <a class="btn btn-success btn-outline-success btn-rounded" data-target="#tambah" data-toggle="modal">Tambah Permission</a>
                  ...
                  <div class="card-block">
                      <div class="table-responsive dt-responsive">
                          <table id="permission" class="table table-striped table-bordered nowrap">
                              <thead>
                                  <tr>
                                    <th>No</th>
                                    <th>Nama</th>
...
<!-- Modal -->
       <div class="modal md-effect-10" id="tambah" tabindex="-1">
       ...
       <!-- /.modal -->
       <!-- Modal -->
              <div class="modal md-modal md-effect-10" id="editpermission" tabindex="-1">
                <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                  <h5 class="modal-title">Tambah Permisson</h5>
                  ...
                  <div class="modal-body">
                  <form class="" action="{{url('setup/update_permission')}}" method="post">
                    @method('PUT')
                    <div class="form-group">
                      <label for="">Nama</label>
...
$(document).ready(function() {
  ...
  $('#permission').DataTable({
    ...
    var modal = $(this)
    modal.find('.modal-title').text('Edit Permission ' + id)
