...
@section('content')
  ...
  <form action="{{route('users.store')}}" class="validation-wizard wizard-circle" method="POST" id="form_user">
    <!-- Step 1 -->
    <h6>Data Diri</h6>
    <section>
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control required" id="wfirstName2" name="nama_lengkap" placeholder="Nama Lengkap"> </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
            <label for="wlastName2"> Gelar Akademik : <span class="danger">*</span> </label>
            <input type="text" class="form-control required" id="wlastName2" name="gelar" placeholder="Ex : Sarjana Komputer, Master Komputer. pisahkan dengan koma jika lebih dari 1"> </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="tel" class="form-control required" id="wphoneNumber2" name="telpon" onkeypress="return angka(event)"> </div>
        </div>
      </div>
      <div class="row">
        <div class="col-md-6">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control date-picker" id="wdate2" name="tgl_lahir" data-date-format="yyyy-mm-dd" data-date-viewmode="years" readonly> </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control required" name="no_identitas" onkeypress="return angka(event)" maxlength="16"> </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control required" name="no_npwp" onkeypress="return angka(event)"> </div>
        </div>
      </div>
    </section>
    <!-- Step 2 -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <textarea name="alamat_rumah" id="shortDescription3" rows="6" class="form-control"></textarea>
            <span>*</span>
          </div>
        </div>
        <div class="col-md-12">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="wint1" name="no_sk">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="email" class="form-control required" id="behName3" name="email">
          </div>
          <div class="form-group">
