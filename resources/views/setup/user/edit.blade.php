...
@section('content')
  ...
  <form action="{{route('users.update',[$user->id])}}" class="validation-wizard wizard-circle" method="POST" id="form_user">
    @method('PUT')
    <!-- Step 1 -->
    <h6>Data Diri</h6>
    <section>
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control required select2" name="kelamin">
              ...
              <option value="Perempuan" {{($profile->jenis_identitas=="Perempuan")?"selected":""}}>Perempuan</option>
            </select>
             </div>
        </div>
        <div class="col-md-6">
